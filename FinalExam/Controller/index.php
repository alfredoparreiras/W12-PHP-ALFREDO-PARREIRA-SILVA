    ...
    switch($op){
        ...
        case 900:
            if(isset($_SESSION['email'])){
                ...
                $pageData['content'] = Country::list();
            }
            else{
                $pageData['content'] = "<h1>You're not allowed to access this page. Please Log In</h1>";
            }
            WebPage::render($pageData);
            break;
        case 902: 
            $pageData['content'] = Country::edit();
            WebPage::render($pageData);
            break;
        case 903: 
            $pageData['content'] = Country::save();
            WebPage::render($pageData);
            break;
        case 904:
            $pageData['content'] = Country::delete();
            WebPage::render($pageData);
            break;
        default:
